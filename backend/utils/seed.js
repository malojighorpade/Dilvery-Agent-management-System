...
async function seed() {
  ...
  const products = await Product.insertMany([
    { name: 'Soap Bar 100g', sku: 'SOAP100', brand: brand1._id, category: 'Personal Care', unit: 'piece', amount: 30 },
    { name: 'Shampoo 200ml', sku: 'SHAM200', brand: brand1._id, category: 'Personal Care', unit: 'piece', amount: 120 },
    { name: 'Detergent 1kg', sku: 'DET1KG', brand: brand1._id, category: 'Household', unit: 'kg', amount: 90 },
    { name: 'Orange Juice 1L', sku: 'OJ1L', brand: brand2._id, category: 'Beverages', unit: 'litre', amount: 80 },
    { name: 'Mango Drink 500ml', sku: 'MD500', brand: brand2._id, category: 'Beverages', unit: 'piece', amount: 40 },
  ]);
